...
const Hero = () => {
    return (
        <div id='home' className="flex flex-col justify-center items-center min-h-screen bg-white w-11/12 max-w-3xl mx-auto text-center ">
            ...
            <p className='text-gray-500'>MERN Stack developer with experience building and deploying scalable web applications. Proficient in
                React, Node.js, MongoDB, and RESTful APIs. Strong foundation in frontend design with Tailwind CSS and
                Git version control. Eager to contribute to fast-paced development teams and grow professionally.</p>
